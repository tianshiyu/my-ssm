...
//        super(new AntPathRequestMatcher("/login.do","POST"));
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse httpServletResponse) throws AuthenticationException, IOException, ServletException {
        ...
        logger.info("EmailCodeAuthenticationFilter运行");
        ...
        if(postOnly && !request.getMethod().equals("POST") ){
            ...
            if(flag){
                token  = new EmailCodeAuthenticationToken(email, credentials);
            }else{
            ...
            交给 manager 发证
             */
            logger.info("EmailCodeAuthenticationFilter运行结束");
    ...
    public String getEmail(HttpServletRequest request ){
        return request.getParameter(DEFAULT_EMAIL_NAME);
    }
    public String getCredentials(HttpServletRequest request ){
        return request.getParameter(DEFAULT_PASSWORD);
    }
    /**
